...
- Use the hosted tool at
  https://arling.sk/google-oauth-redirect-doctor/ freely, for any
  purpose, personal or commercial, at no cost.
- Read the source of `index.html` / `doctor-google.js` to understand
...
- Use the "Google OAuth Redirect Doctor" name, the ARLing s. r. o.
